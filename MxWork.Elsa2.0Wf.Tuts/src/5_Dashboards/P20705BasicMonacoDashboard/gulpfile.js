...
function copy_monaco_editor_min(cb) {
    src('node_modules/monaco-editor/min/vs/**/*').pipe(dest('wwwroot/monaco-editor/min/vs'));
    cb();
}

function copy_monaco_editor_min_maps(cb) {
    
    src('node_modules/monaco-editor/min-maps/vs/**/*').pipe(dest('wwwroot/monaco-editor/min-maps/vs'));
    cb();
}
...
exports.copy_monaco_editor_min = copy_monaco_editor_min;
exports.copy_monaco_editor_min_maps = copy_monaco_editor_min_maps;
...
exports.default = series(clean, build, copy_rootfiles, copy_monaco_editor_min, copy_monaco_editor_min_maps,
    copy_jquery, copy_jquery_validation, copy_jquery_validation_unobtrusive,
    copy_bootstrap, trial_console_log);

// both are working. Use anyone, monaco-editor/**/* or monaco-editor/**