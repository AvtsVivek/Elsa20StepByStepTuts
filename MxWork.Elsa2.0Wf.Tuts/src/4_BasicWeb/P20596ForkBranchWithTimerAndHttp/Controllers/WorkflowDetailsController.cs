...
using P20596ForkBranchWithTimerAndHttp.Workflows;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;


namespace P20596ForkBranchWithTimerAndHttp.Controllers
{
    ...
    public class WorkflowDetailsController : Controller
    {
        ...
        {
            return new WorkflowDefinitionIdSpecification(nameof(TimerHttpWorkflow));
        }
